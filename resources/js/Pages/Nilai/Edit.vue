...
const form = useForm({
    mahasiswa_id: props.nilai.mahasiswa_id,
    mata_kuliah_id: props.nilai.mata_kuliah_id,
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Nilai</h2>
        </template>
                    ...
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="submit">
                            ...
                            <div>
                                ...
                                <input id="nilai" v-model="form.nilai" type="number" class="mt-1 block w-full" required>
